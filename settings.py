...
ADMINS = (
    ('Matt Long', 'beaver08@gmail.com'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'acdb'             # Or path to database file if using sqlite3.
...
INSTALLED_APPS = (
    ...
    'ancientCity.cityBrowser',
    'ancientCity.thirdparty.south',
)
